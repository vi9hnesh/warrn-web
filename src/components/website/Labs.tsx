        ...
        <section className="py-16 md:py-32">
            <div className="mx-auto max-w-5xl space-y-8 px-6 md:space-y-12">
                <div className="mx-auto max-w-xl space-y-6 text-center md:space-y-12">
                    <h2 className="text-balance text-4xl font-medium lg:text-5xl">Computer Labs</h2>
                    <hr />
                    <p>We are a team of engineers, designers, and incident responders who are passionate about building tools that help teams get work done.</p>
                </div>
                <img
