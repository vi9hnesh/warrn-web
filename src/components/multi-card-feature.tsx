...
import DisplayCards from "@/components/website/DisplayCards";
                    ...
                    <Card className="group overflow-hidden shadow-black/5 sm:col-span-3 sm:rounded-none sm:rounded-tl-xl">
                        <CardHeader>
                            <div className="md:p-6">
                                <p className="font-medium">Alerts & Incidents</p>
                                <p className="text-muted-foreground mt-3 max-w-sm text-sm">Warrnagen triages alerts and incidents, and routes them to the right team.</p>
                            </div>
                        </CardHeader>
                        ...
                        <div className="relative h-fit pl-6 md:pl-12">
                            ...
                            <div className="bg-background overflow-hidden rounded-tl-lg border-l border-t pl-2 pt-2 dark:bg-zinc-950">
                                ...
                                <img
                                    ...
                                    className="shadow dark:hidden object-cover object-[25%_40%] scale-101 m-auto"
                                    alt="Warrnagen illustration"
                                    width={1207}
                                    height={929}
                                />
                            </div>
